...
def parse_arguments():
    ...
    parser.add_argument('-r', '--root_folder', help='root folder of dataset',
                        default=str('/mnt/8tssd/AdverseWeather/view_of_delft_PUBLIC/lidar/training/'))
...
if __name__ == '__main__':
    ...
    for lidar_folder in LIDAR_FOLDERS:
        ...
        for available_alpha in available_alphas:
            ...
            dst_folder = f'/mnt/8tssd/AdverseWeather/view_of_delft_PUBLIC/fog_sim_lidar_no_intensity/_CVL_beta_{available_alpha:.3f}'
