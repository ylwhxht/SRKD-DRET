...
class WaymoDataset_PAIR_KD(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        super().__init__(
            dataset_cfg=dataset_cfg, class_names=class_names, training=training, root_path=root_path, logger=logger
        )
        self.use_weatherlabels = False
        #self.augpath = Path('/mnt/8tssd/WaymoWeatherLabels/All_Fixed_Aug_Data/npy') 
        self.augpath = Path('/mnt/8tssd/WaymoWeatherLabels/New_Aug_Data/npy')
