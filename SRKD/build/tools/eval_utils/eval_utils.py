...
def statistics_info(cfg, ret_dict, metric, disp_dict):
    ...
    max_thresh = cfg.MODEL.POST_PROCESSING.RECALL_THRESH_LIST[2]
    disp_dict['recall_%s' % str(max_thresh)] = \
        '(%.2f,%.2f)' % (metric['recall_roi_%s' % str(max_thresh)] / metric['gt_num'] * 100, metric['recall_rcnn_%s' % str(max_thresh)] / metric['gt_num'] * 100)
