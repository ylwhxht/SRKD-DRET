...
class PVRCNNPlusPlus(Detector3DTemplate):
    ...
    def forward(self, batch_dict):
        ...
        if self.training:
            ...
            keyinfos = ['pred_dicts','target_dicts','spatial_features_2d','gt_roifeatures', 'batch_size', 'rain_idx', 'gt_boxes', 'points', 
            'multiscale_pooled_features', 'cls_preds', 'box_preds', 'num_anchors_per_location', 'box_cls_labels']
            for key in keyinfos:
