...
class WaymoDataset(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        #self.augpath = Path('/mnt/8tssd/AdverseWeather/All_Fixed_Aug_Data/npy') 
        #self.augpath = Path('/mnt/8tssd/AdverseWeather/New_Aug_Data/npy')
    ...
    def include_waymo_data(self, mode):
        ...
        for k in range(len(self.sample_sequence_list)):
            ...
            info_path = Path('/home/hx/OpenPCDet/data/waymo/waymo_processed_data_v0_5_0')/ sequence_name / ('%s.pkl' % sequence_name)
        ...
        if self.dataset_cfg.SAMPLED_INTERVAL[mode] > 1:
            for k in range(0, len(self.infos), self.dataset_cfg.SAMPLED_INTERVAL[mode]):
                ...
                if lidar_file.exists() and self.val:
                    continue
            ...
            for k in range(0, len(self.infos), 1):
                ...
                sample_idx = pc_info['sample_idx']
                lidar_file = self.augpath / sequence_name / ('%03d.npy' % sample_idx)
                if not lidar_file.exists() or self.val:
                    continue
                sampled_waymo_infos.append(self.infos[k])
        else:
            for k in range(0, len(self.infos), 1):
...
if __name__ == '__main__':
    ...
    if args.func == 'create_waymo_infos':
        ...
        create_waymo_infos(
             ...
             data_path= ROOT_DIR,
             save_path= Path("/home/hx/OpenPCDet/data/waymo"),
