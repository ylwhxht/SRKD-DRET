...
def parse_config():
    ...
    #parser.add_argument('--teacher_ckpt', type=str, default='/home/hx/OpenPCDet/output/waymo_models/voxel_rcnn_with_centerhead_dyn_voxel/rain/ckpt/checkpoint_epoch_29.pth', help='teacher checkpoint to start from')
    #parser.add_argument('--teacher_ckpt', type=str, default='/home/hx/OpenPCDet/output/waymo_models/pv_rcnn_plusplus_KD/pv_rcnn++_fullKD_delincar_4gpus/ckpt/checkpoint_epoch_48.pth', help='teacher checkpoint to start from')
...
if __name__ == '__main__':
    ...
    #bash scripts/dist_train.sh 4   --cfg_file cfgs/waymo_models/voxel_rcnn_with_centerhead_dyn_voxel.yaml --batch_size 8 --workers 0 --epochs 30 --extra_tag "sun"
